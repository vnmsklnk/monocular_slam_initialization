...
feature_matcher = msi.features.feature_matcher_factory(matcher_type=matcher, detector_type=detector)
...
initializer = msi.Initializer(num_fin_features, use_robust_kernel, feature_manager, feature_matcher)
